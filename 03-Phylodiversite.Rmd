...
```{r LineaireZpsqFig, fig.cap = "Approximation de ${(\\mathbf{Zp})}_{s}^{q-1}$ par son développement limité au premier ordre pour $q=1.5$ (a) ($r=q-1$) et $q=0.5$ (b)", fig.ncol = 2, echo = FALSE, ref.label='LineaireZpsqCode', out.width='100%'}
