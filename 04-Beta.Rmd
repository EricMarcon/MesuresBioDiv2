...
La contribution des espèces rares augmente avec le paramètre $n$ (Figure&nbsp;\@ref(fig:HurlbertCFig), page~\@ref(HurlbertCFig)).
...
Sa fonction d'information a été tracée Figure&nbsp;\@ref(fig:IFig), page~\@ref(IFig).
