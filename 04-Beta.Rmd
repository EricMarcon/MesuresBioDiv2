...
```{r JaccardCode, eval=FALSE, size='tiny'}
...
Code R pour la figure:
```{r ChaoJaccardCode, eval=FALSE, size='tiny', tidy=FALSE}
...
Code R pour la figure:
```{r JaccardPCOCode, eval=FALSE, size='tiny'}
...
Code R pour la figure:
```{r BCIPCACode, eval=FALSE, size='tiny'}
...
Code R:
```{r BCIPCA2Code, eval=FALSE, size='tiny'}
...
Code R:
```{r BCICordeCode, eval=FALSE, size='tiny'}
library("adespatial")
...
```{r BetaSampleCode1, eval=FALSE, size='tiny', tidy=FALSE}
library("gplots")
...
Code pour réaliser la figure:
```{r DivPartCode, eval=FALSE, size='tiny', tidy=FALSE}
q <- 1
...
Code R:
```{r DivestCode, eval=FALSE, size='tiny'}
