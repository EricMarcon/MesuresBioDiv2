...
\NormalTok{ei <-}\StringTok{ }\KeywordTok{apply}\NormalTok{(Samples, }\DecValTok{2}\NormalTok{, Richness, }\DataTypeTok{Level =}\NormalTok{ n}\OperatorTok{*}\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{extra), }
            \DataTypeTok{RCorrection =} \StringTok{"Chao1"}\NormalTok{)}
...
\NormalTok{ExtrapolateS <-}\StringTok{ }\ControlFlowTok{function}\NormalTok{(Ns) \{}
  ...
  \KeywordTok{sink}\NormalTok{(}\KeywordTok{tempfile}\NormalTok{()) }\CommentTok{# Suppression des messages de jackknife()}
