...
Enfin, les données fournies par le package \emph{entropart} sous le nom ``Paracou618'' sont deux inventaires de l'année 2012 limités à un hectare chacun dans les parcelles 6 et 18 de la forêt de Paracou, soient 1124 arbres dans 229 espèces.
...
\NormalTok{    ])}
\NormalTok{Psi[, }\DecValTok{1}\NormalTok{] }\SpecialCharTok{\%\textless{}\textgreater{}\%}
\NormalTok{    sort }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    cumsum }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    rev}
\NormalTok{Psi[, }\DecValTok{2}\NormalTok{] }\SpecialCharTok{\%\textless{}\textgreater{}\%}
\NormalTok{    sort }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    cumsum }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    rev}
...
\chapter{Cadre}\label{chap-cadrephyfonc}
...
\textcite{Swenson2009} puis \textcite{Hahn2024} ont montré que la corrélation entre les deux diversités était faible, voire négative.
...
\CommentTok{\# Matrice des espèces (les lignes de Sp sont les}
\CommentTok{\# coordonnées des vecteurs)}
...
\CommentTok{\# Réutilisation de Paracou618.Taxonomy au format phylog}
\CommentTok{\# (cf. calcul de FAD)}
...
\section{Synthèse}\label{synthuxe8se-4}
...
\NormalTok{ei }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(Samples, }\DecValTok{2}\NormalTok{, Richness, }\AttributeTok{Level =}\NormalTok{ n}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1} \SpecialCharTok{+}\NormalTok{ extra), }
            \AttributeTok{RCorrection =} \StringTok{"Chao1"}\NormalTok{)}
...
\NormalTok{ExtrapolateS }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(Ns) \{}
  ...
  \FunctionTok{sink}\NormalTok{(}\FunctionTok{tempfile}\NormalTok{()) }\CommentTok{\# Suppression des messages de jackknife()}
