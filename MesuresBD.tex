...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Ns }\OtherTok{\textless{}{-}} \FunctionTok{sort}\NormalTok{(}\FunctionTok{colSums}\NormalTok{(BCI), }\AttributeTok{decr =} \ConstantTok{TRUE}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Vérification: nombre d\textquotesingle{}espèces observées en moyenne et non}
\CommentTok{\# observées}
...
\NormalTok{(NonObs }\OtherTok{\textless{}{-}} \FunctionTok{jackknife}\NormalTok{(}\FunctionTok{AbdFreqCount}\NormalTok{(Ns))}\SpecialCharTok{$}\NormalTok{Nhat }\SpecialCharTok{{-}} \FunctionTok{length}\NormalTok{(Ns))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pnpmle}\NormalTok{(DistNs.SPECIES)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{pcg}\NormalTok{(DistNs.SPECIES)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Yi }\OtherTok{\textless{}{-}}\NormalTok{ SAC}\SpecialCharTok{$}\NormalTok{richness}
\NormalTok{N }\OtherTok{\textless{}{-}} \FunctionTok{length}\NormalTok{(Yi)}
\NormalTok{Xi }\OtherTok{\textless{}{-}}\NormalTok{ Yi}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{N)}
...
\NormalTok{Syy }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((Yi }\SpecialCharTok{{-}}\NormalTok{ Ybar)}\SpecialCharTok{\^{}}\DecValTok{2}\NormalTok{)}
...
\NormalTok{Sxy }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{((Xi }\SpecialCharTok{{-}}\NormalTok{ Xbar) }\SpecialCharTok{*}\NormalTok{ (Yi }\SpecialCharTok{{-}}\NormalTok{ Ybar))}
\CommentTok{\# Estimations}
\NormalTok{(Khat }\OtherTok{\textless{}{-}}\NormalTok{ (Xbar }\SpecialCharTok{*}\NormalTok{ Syy }\SpecialCharTok{{-}}\NormalTok{ Ybar }\SpecialCharTok{*}\NormalTok{ Sxy)}\SpecialCharTok{/}\NormalTok{(Ybar }\SpecialCharTok{*}\NormalTok{ Sxx }\SpecialCharTok{{-}}\NormalTok{ Xbar }\SpecialCharTok{*}\NormalTok{ Sxy))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{f }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(Khat) Sxy }\SpecialCharTok{+}\NormalTok{ Khat }\SpecialCharTok{*}\NormalTok{ Sxx }\SpecialCharTok{{-}}\NormalTok{ (Syy }\SpecialCharTok{+} \DecValTok{2} \SpecialCharTok{*}\NormalTok{ Khat }\SpecialCharTok{*}\NormalTok{ Sxy }\SpecialCharTok{+} 
\NormalTok{    Khat }\SpecialCharTok{*}\NormalTok{ Khat }\SpecialCharTok{*}\NormalTok{ Sxx) }\SpecialCharTok{*} \FunctionTok{sum}\NormalTok{(Xi}\SpecialCharTok{/}\NormalTok{(Yi }\SpecialCharTok{+}\NormalTok{ Khat }\SpecialCharTok{*}\NormalTok{ Xi)}\SpecialCharTok{/}\NormalTok{N)}
\CommentTok{\# Résolution numérique, l\textquotesingle{}intervalle de recherche doit être}
\CommentTok{\# fourni}
\NormalTok{Solution }\OtherTok{\textless{}{-}} \FunctionTok{uniroot}\NormalTok{(f, }\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\FloatTok{1e+07}\NormalTok{))}
\NormalTok{(Khat }\OtherTok{\textless{}{-}}\NormalTok{ Solution}\SpecialCharTok{$}\NormalTok{root)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{y }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{nEspeces}
\NormalTok{x }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{nArbres}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(S0 }\OtherTok{\textless{}{-}} \FunctionTok{jackknife}\NormalTok{(}\FunctionTok{AbdFreqCount}\NormalTok{(Ns))}\SpecialCharTok{$}\NormalTok{Nhat }\SpecialCharTok{{-}} \FunctionTok{ncol}\NormalTok{(BCI))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{q.seq }\OtherTok{\textless{}{-}} \FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{2}\NormalTok{, .}\DecValTok{1}\NormalTok{)}
\NormalTok{  P6D}\OtherTok{\textless{}{-}} \FunctionTok{CommunityProfile}\NormalTok{(Diversity, Paracou618.MC}\SpecialCharTok{$}\NormalTok{Nsi[, }\DecValTok{1}\NormalTok{], q.seq)}
\NormalTok{  P18D}\OtherTok{\textless{}{-}} \FunctionTok{CommunityProfile}\NormalTok{(Diversity, Paracou618.MC}\SpecialCharTok{$}\NormalTok{Nsi[, }\DecValTok{2}\NormalTok{], q.seq)}
  \FunctionTok{autoplot}\NormalTok{(P6D, }\AttributeTok{xlab =} \StringTok{"q"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Diversité"}\NormalTok{) }\SpecialCharTok{+}
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, y), }\FunctionTok{as.data.frame.list}\NormalTok{(P18D), }\AttributeTok{lty =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Psi }\OtherTok{\textless{}{-}} \FunctionTok{as.data.frame}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Psi[Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ps }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{, }
\NormalTok{    ])}
\NormalTok{Psi[, }\DecValTok{1}\NormalTok{] }\SpecialCharTok{\%\textless{}\textgreater{}\%}\NormalTok{ sort }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ cumsum }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ rev}
\NormalTok{Psi[, }\DecValTok{2}\NormalTok{] }\SpecialCharTok{\%\textless{}\textgreater{}\%}\NormalTok{ sort }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ cumsum }\SpecialCharTok{\%\textgreater{}\%}\NormalTok{ rev}
\NormalTok{Psi}\SpecialCharTok{$}\NormalTok{x }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(Psi)}
\FunctionTok{ggplot}\NormalTok{(Psi, }\FunctionTok{aes}\NormalTok{(x)) }\SpecialCharTok{+} \FunctionTok{geom\_path}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ P006)) }\SpecialCharTok{+} \FunctionTok{geom\_path}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ P018), }
    \AttributeTok{lty =} \DecValTok{2}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Espèces"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Fréquence"}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{scale\_x\_log10}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
Il a été également obtenu par d'autres auteurs \autocites[Annexe S1]{Mao2007,Vinck2012,Chao2013} avec d'autres approches.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{Tsallis}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ns, }\AttributeTok{q =} \DecValTok{1}\NormalTok{, }\AttributeTok{Correction =} \StringTok{"ZhangGrabchak"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{Diversity}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ns, }\AttributeTok{q =} \DecValTok{1}\NormalTok{, }\AttributeTok{Correction =} \StringTok{"ZhangGrabchak"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NsP6 }\OtherTok{\textless{}{-}} \FunctionTok{as.AbdVector}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Nsi[, }\DecValTok{1}\NormalTok{])}
\NormalTok{(S6 }\OtherTok{\textless{}{-}} \FunctionTok{Richness}\NormalTok{(NsP6, }\AttributeTok{Correction =} \StringTok{"Jackknife"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NsP18 }\OtherTok{\textless{}{-}} \FunctionTok{as.AbdVector}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Nsi[, }\DecValTok{2}\NormalTok{])}
\NormalTok{(S18 }\OtherTok{\textless{}{-}} \FunctionTok{Richness}\NormalTok{(NsP18, }\AttributeTok{Correction =} \StringTok{"Jackknife"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{zeta6 }\OtherTok{\textless{}{-}} \FunctionTok{CommunityProfile}\NormalTok{(GenSimpson, NsP6, }\DecValTok{1}\SpecialCharTok{:}\NormalTok{(S }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{))}
\NormalTok{sigma6 }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{(S }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{), }\ControlFlowTok{function}\NormalTok{(r) }\FunctionTok{GenSimp.sd}\NormalTok{(NsP6, r))}
\NormalTok{ic6 }\OtherTok{\textless{}{-}} \FunctionTok{qnorm}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}} \FloatTok{0.05}\SpecialCharTok{/}\DecValTok{2}\NormalTok{) }\SpecialCharTok{*}\NormalTok{ sigma6}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(}\FunctionTok{sum}\NormalTok{(NsP6))}
\NormalTok{zeta6}\SpecialCharTok{$}\NormalTok{low }\OtherTok{\textless{}{-}}\NormalTok{ zeta6}\SpecialCharTok{$}\NormalTok{y }\SpecialCharTok{{-}}\NormalTok{ ic6}
\NormalTok{zeta6}\SpecialCharTok{$}\NormalTok{high }\OtherTok{\textless{}{-}}\NormalTok{ zeta6}\SpecialCharTok{$}\NormalTok{y }\SpecialCharTok{+}\NormalTok{ ic6}
\CommentTok{\# Profil P18}
\NormalTok{zeta18 }\OtherTok{\textless{}{-}} \FunctionTok{CommunityProfile}\NormalTok{(GenSimpson, NsP18, }\DecValTok{1}\SpecialCharTok{:}\NormalTok{(S }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{))}
\NormalTok{sigma18 }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\NormalTok{(S }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{), }\ControlFlowTok{function}\NormalTok{(r) }\FunctionTok{GenSimp.sd}\NormalTok{(NsP18, r))}
\NormalTok{ic18 }\OtherTok{\textless{}{-}} \FunctionTok{qnorm}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}} \FloatTok{0.05}\SpecialCharTok{/}\DecValTok{2}\NormalTok{) }\SpecialCharTok{*}\NormalTok{ sigma18}\SpecialCharTok{/}\FunctionTok{sqrt}\NormalTok{(}\FunctionTok{sum}\NormalTok{(NsP18))}
\NormalTok{zeta18}\SpecialCharTok{$}\NormalTok{low }\OtherTok{\textless{}{-}}\NormalTok{ zeta18}\SpecialCharTok{$}\NormalTok{y }\SpecialCharTok{{-}}\NormalTok{ ic18}
\NormalTok{zeta18}\SpecialCharTok{$}\NormalTok{high }\OtherTok{\textless{}{-}}\NormalTok{ zeta18}\SpecialCharTok{$}\NormalTok{y }\SpecialCharTok{+}\NormalTok{ ic18}
\CommentTok{\# Transformation en diversité}
\NormalTok{zeta6D }\OtherTok{\textless{}{-}}\NormalTok{ zeta6}
\NormalTok{zeta6D}\SpecialCharTok{$}\NormalTok{y }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ (zeta6}\SpecialCharTok{$}\NormalTok{y)}\SpecialCharTok{\^{}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{zeta6}\SpecialCharTok{$}\NormalTok{x))}
\NormalTok{zeta6D}\SpecialCharTok{$}\NormalTok{low }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ (zeta6}\SpecialCharTok{$}\NormalTok{low)}\SpecialCharTok{\^{}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{zeta6}\SpecialCharTok{$}\NormalTok{x))}
\NormalTok{zeta6D}\SpecialCharTok{$}\NormalTok{high }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ (zeta6}\SpecialCharTok{$}\NormalTok{high)}\SpecialCharTok{\^{}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{zeta6}\SpecialCharTok{$}\NormalTok{x))}
\NormalTok{zeta18D }\OtherTok{\textless{}{-}}\NormalTok{ zeta18}
\NormalTok{zeta18D}\SpecialCharTok{$}\NormalTok{y }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ (zeta18}\SpecialCharTok{$}\NormalTok{y)}\SpecialCharTok{\^{}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{zeta18}\SpecialCharTok{$}\NormalTok{x))}
\NormalTok{zeta18D}\SpecialCharTok{$}\NormalTok{low }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ (zeta18}\SpecialCharTok{$}\NormalTok{low)}\SpecialCharTok{\^{}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{zeta18}\SpecialCharTok{$}\NormalTok{x))}
\NormalTok{zeta18D}\SpecialCharTok{$}\NormalTok{high }\OtherTok{\textless{}{-}} \DecValTok{1}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ (zeta18}\SpecialCharTok{$}\NormalTok{high)}\SpecialCharTok{\^{}}\NormalTok{(}\DecValTok{1}\SpecialCharTok{/}\NormalTok{zeta18}\SpecialCharTok{$}\NormalTok{x))}
\CommentTok{\# Figure}
\NormalTok{gga }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, }\AttributeTok{ymin =}\NormalTok{ low, }\AttributeTok{ymax =}\NormalTok{ high), }
              \FunctionTok{as.data.frame.list}\NormalTok{(zeta18D), }\AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, y), }\FunctionTok{as.data.frame.list}\NormalTok{(zeta18D), }\AttributeTok{col =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, }\AttributeTok{ymin =}\NormalTok{ low, }\AttributeTok{ymax =}\NormalTok{ high), }
              \FunctionTok{as.data.frame.list}\NormalTok{(zeta6D), }\AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, y), }\FunctionTok{as.data.frame.list}\NormalTok{(zeta6D), }\AttributeTok{col =} \StringTok{"darkgreen"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Ordre de diversité"}\NormalTok{, }
       \AttributeTok{y =} \StringTok{"Diversité de Simpson généralisée"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{tag =} \StringTok{"a"}\NormalTok{)}
\CommentTok{\# Calcul des profils HCDT}
\NormalTok{D6 }\OtherTok{\textless{}{-}} \FunctionTok{CommunityProfile}\NormalTok{(Diversity, NsP6, }\AttributeTok{NumberOfSimulations =} \DecValTok{10}\NormalTok{,}
\AttributeTok{q.seq=}\NormalTok{q.seq, }\AttributeTok{Correction =} \StringTok{"UnveilJ"}\NormalTok{)}
\NormalTok{D18 }\OtherTok{\textless{}{-}} \FunctionTok{CommunityProfile}\NormalTok{(Diversity, NsP18, }\AttributeTok{NumberOfSimulations =} \DecValTok{10}\NormalTok{,}
\AttributeTok{q.seq=}\NormalTok{q.seq, }\AttributeTok{Correction =} \StringTok{"UnveilJ"}\NormalTok{)}
\CommentTok{\# Figure}
\NormalTok{ggb }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =}\NormalTok{ D6}\SpecialCharTok{$}\NormalTok{x, D6}\SpecialCharTok{$}\NormalTok{y, D18}\SpecialCharTok{$}\NormalTok{y)) }\SpecialCharTok{+}
  \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, }\AttributeTok{ymin =}\NormalTok{ low, }\AttributeTok{ymax =}\NormalTok{ high), }\FunctionTok{as.data.frame.list}\NormalTok{(D6), }
              \AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, D6.y), }\AttributeTok{col =} \StringTok{"darkgreen"}\NormalTok{, }\AttributeTok{lty =} \DecValTok{2}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{geom\_ribbon}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, }\AttributeTok{ymin =}\NormalTok{ low, }\AttributeTok{ymax =}\NormalTok{ high), }\FunctionTok{as.data.frame.list}\NormalTok{(D18), }
              \AttributeTok{alpha =} \FloatTok{0.3}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x, D18.y), }\AttributeTok{col =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+} 
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Ordre de diversité"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Nombre de Hill"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{tag =} \StringTok{"b"}\NormalTok{)}
...
\NormalTok{  Difference }\OtherTok{\textless{}{-}} \FunctionTok{list}\NormalTok{(}\AttributeTok{x =}\NormalTok{ zeta18}\SpecialCharTok{$}\NormalTok{x, }\AttributeTok{y =}\NormalTok{ zeta18}\SpecialCharTok{$}\NormalTok{y}\SpecialCharTok{{-}}\NormalTok{zeta6}\SpecialCharTok{$}\NormalTok{y)}
  \FunctionTok{class}\NormalTok{(Difference) }\OtherTok{\textless{}{-}} \FunctionTok{class}\NormalTok{(zeta18)}
\NormalTok{  icDifference }\OtherTok{\textless{}{-}} \FunctionTok{qnorm}\NormalTok{(}\DecValTok{1}\FloatTok{{-}0.05}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}\SpecialCharTok{*}\FunctionTok{sqrt}\NormalTok{(sigma6}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(NsP6) }
                                       \SpecialCharTok{+}\NormalTok{ sigma18}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(NsP18))}
\NormalTok{  Difference}\SpecialCharTok{$}\NormalTok{low }\OtherTok{\textless{}{-}}\NormalTok{ Difference}\SpecialCharTok{$}\NormalTok{y }\SpecialCharTok{{-}}\NormalTok{ icDifference}
\NormalTok{  Difference}\SpecialCharTok{$}\NormalTok{high }\OtherTok{\textless{}{-}}\NormalTok{ Difference}\SpecialCharTok{$}\NormalTok{y }\SpecialCharTok{+}\NormalTok{ icDifference}
  \CommentTok{\# Plot}
  \FunctionTok{autoplot}\NormalTok{(Difference, }\AttributeTok{xlab =} \StringTok{"Ordre de diversité"}\NormalTok{, }
           \AttributeTok{ylab =} \StringTok{"Différence d\textquotesingle{}entropie"}\NormalTok{) }\SpecialCharTok{+} 
    \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =} \DecValTok{0}\NormalTok{, }\AttributeTok{col =} \StringTok{"blue"}\NormalTok{, }\AttributeTok{lty =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Estimation du nombre d\textquotesingle{}espèces}
\NormalTok{Ns }\OtherTok{\textless{}{-}} \FunctionTok{colSums}\NormalTok{(BCI)}
\NormalTok{UBNs }\OtherTok{\textless{}{-}} \FunctionTok{jackknife}\NormalTok{(}\FunctionTok{AbdFreqCount}\NormalTok{(Ns), }\AttributeTok{k =} \DecValTok{1}\NormalTok{)}\SpecialCharTok{$}\NormalTok{Nhat}
\CommentTok{\# Profil}
\NormalTok{Inq }\OtherTok{\textless{}{-}}\NormalTok{ DivPrf }\OtherTok{\textless{}{-}} \FunctionTok{CommunityProfile}\NormalTok{(Diversity, Ns)}
\NormalTok{Inq}\SpecialCharTok{$}\NormalTok{y }\OtherTok{\textless{}{-}}\NormalTok{ UBNs}\SpecialCharTok{/}\NormalTok{DivPrf}\SpecialCharTok{$}\NormalTok{y}
\FunctionTok{autoplot}\NormalTok{(Inq, }\AttributeTok{xlab =} \StringTok{"Ordre de diversité"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Inéquitabilité"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Inq}\SpecialCharTok{$}\NormalTok{y }\OtherTok{\textless{}{-}} \FunctionTok{log}\NormalTok{(DivPrf}\SpecialCharTok{$}\NormalTok{y)}\SpecialCharTok{/}\FunctionTok{log}\NormalTok{(UBNs)}
\FunctionTok{autoplot}\NormalTok{(Inq, }\AttributeTok{xlab =} \StringTok{"Ordre de diversité"}\NormalTok{, }\AttributeTok{ylab =} \StringTok{"Indice de Pielou"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{rmc }\OtherTok{\textless{}{-}} \FunctionTok{MetaCommunity}\NormalTok{(}\FunctionTok{sapply}\NormalTok{(}\DecValTok{10}\SpecialCharTok{:}\DecValTok{1000}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(n) }\FunctionTok{rCommunity}\NormalTok{(}\DecValTok{1}\NormalTok{, n)))}
\CommentTok{\# Richesse et Shannon}
\NormalTok{S }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(rmc}\SpecialCharTok{$}\NormalTok{Psi, }\DecValTok{2}\NormalTok{, Richness)}
\NormalTok{H }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(rmc}\SpecialCharTok{$}\NormalTok{Psi, }\DecValTok{2}\NormalTok{, Shannon)}
\NormalTok{ggH }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(S, H), }\FunctionTok{aes}\NormalTok{(S, H)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{scale\_x\_log10}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x=}\StringTok{"S (échelle logarithmique)"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{tag =} \StringTok{"a"}\NormalTok{)}
...
\NormalTok{ggJ }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(S, J), }\FunctionTok{aes}\NormalTok{(S, J)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{labs}\NormalTok{(}\AttributeTok{tag =} \StringTok{"b"}\NormalTok{)}
\NormalTok{E }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(rmc}\SpecialCharTok{$}\NormalTok{Psi, }\DecValTok{2}\NormalTok{, Simpson)}
\NormalTok{ggE }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(S, E), }\FunctionTok{aes}\NormalTok{(S, E)) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{labs}\NormalTok{(}\AttributeTok{tag =} \StringTok{"c"}\NormalTok{)}
\NormalTok{J2 }\OtherTok{\textless{}{-}}\NormalTok{ E}\SpecialCharTok{/}\NormalTok{(}\DecValTok{1{-}1}\SpecialCharTok{/}\NormalTok{S)}
\NormalTok{ggJ2 }\OtherTok{\textless{}{-}} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(S, J2), }\FunctionTok{aes}\NormalTok{(S, J2)) }\SpecialCharTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{phyTree }\OtherTok{\textless{}{-}}\NormalTok{ Paracou618.Taxonomy}
\CommentTok{\# La conversion as.hclust() double les distances. Il faut}
\CommentTok{\# donc les diviser par deux.}
\NormalTok{phyTree}\SpecialCharTok{$}\NormalTok{edge.length }\OtherTok{\textless{}{-}}\NormalTok{ phyTree}\SpecialCharTok{$}\NormalTok{edge.length}\SpecialCharTok{/}\DecValTok{2}
...
\NormalTok{Tree }\OtherTok{\textless{}{-}} \FunctionTok{hclust2phylog}\NormalTok{(hTree)}
\CommentTok{\# Tree$Wdist contient les valeurs de sqrt(2*distance)}
\NormalTok{(FAD }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(Tree}\SpecialCharTok{$}\NormalTok{Wdist}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\DecValTok{2}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(MFAD }\OtherTok{\textless{}{-}}\NormalTok{ FAD}\SpecialCharTok{/}\FunctionTok{length}\NormalTok{(Tree}\SpecialCharTok{$}\NormalTok{leaves))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Ps }\OtherTok{\textless{}{-}}\NormalTok{ Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ps[Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ps}\SpecialCharTok{\textgreater{}}\DecValTok{0}\NormalTok{]}
\NormalTok{Ps }\OtherTok{\textless{}{-}} \FunctionTok{sort}\NormalTok{(Ps, }\AttributeTok{decreasing =} \ConstantTok{TRUE}\NormalTok{)}
\CommentTok{\# Fréquences cumulées}
\NormalTok{PsCum }\OtherTok{\textless{}{-}} \FunctionTok{cumsum}\NormalTok{(Ps)}
\NormalTok{Xgauche }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, PsCum)}
\NormalTok{Xdroite }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(PsCum, }\DecValTok{1}\NormalTok{)}
...
\NormalTok{DistanceMatrix }\OtherTok{\textless{}{-}}\NormalTok{ DistanceMatrix[}\FunctionTok{names}\NormalTok{(Ps), }\FunctionTok{names}\NormalTok{(Ps)]}
\CommentTok{\# Taille des niches}
\NormalTok{ts }\OtherTok{\textless{}{-}} \FunctionTok{rowSums}\NormalTok{(DistanceMatrix)}
\NormalTok{fs }\OtherTok{\textless{}{-}}\NormalTok{ ts}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(ts)}
\CommentTok{\# Fréquences cumulées}
\NormalTok{fsCum }\OtherTok{\textless{}{-}} \FunctionTok{cumsum}\NormalTok{(fs)}
\NormalTok{Ybas }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, fsCum)}
\NormalTok{Yhaut }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(fsCum, }\DecValTok{1}\NormalTok{)}
\CommentTok{\# Rectangles occupés par chaque espèce}
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(Xgauche, Ybas, Xdroite, Yhaut)) }\SpecialCharTok{+}
  \FunctionTok{geom\_rect}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{xmin=}\NormalTok{ Xgauche, }\AttributeTok{xmax=}\NormalTok{ Xdroite, }\AttributeTok{ymin=}\NormalTok{ Ybas, }\AttributeTok{ymax=}\NormalTok{ Yhaut), }
             \AttributeTok{color =} \StringTok{"black"}\NormalTok{, }\AttributeTok{fill =} \StringTok{"white"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{coord\_fixed}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Fréquence"}\NormalTok{, }\AttributeTok{y=}\StringTok{"Niche"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Ps }\OtherTok{\textless{}{-}}\NormalTok{ Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ps}
\FunctionTok{PDFD}\NormalTok{(Ps, Paracou618.Taxonomy)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# Vecteur des probabilités}
\NormalTok{Ps }\OtherTok{\textless{}{-}}\NormalTok{ Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ps}
\FunctionTok{Rao}\NormalTok{(Ps, Paracou618.Taxonomy)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(}\StringTok{"ade4"}\NormalTok{)}
\FunctionTok{divc}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(Ps), Paracou618.Taxonomy}\SpecialCharTok{$}\NormalTok{Wdist)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{divc}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Psi), Paracou618.Taxonomy}\SpecialCharTok{$}\NormalTok{Wdist)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{apply}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Psi, }\DecValTok{2}\NormalTok{, Rao, }\AttributeTok{Tree =}\NormalTok{ Paracou618.Taxonomy)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{traits }\OtherTok{\textless{}{-}} \FunctionTok{read.csv2}\NormalTok{(}\StringTok{"data/rao.traits.csv"}\NormalTok{, }\AttributeTok{row.names =} \DecValTok{1}\NormalTok{, }\AttributeTok{header =}\NormalTok{ T)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{hf }\OtherTok{\textless{}{-}} \FunctionTok{hclust}\NormalTok{(}\FunctionTok{dist}\NormalTok{(pcaf}\SpecialCharTok{$}\NormalTok{tab), }\StringTok{"ward.D"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Transformation de l\textquotesingle{}arbre du format hclust au format phylog}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table.phylog}\NormalTok{(pcaf}\SpecialCharTok{$}\NormalTok{tab[}\FunctionTok{names}\NormalTok{(phyf}\SpecialCharTok{$}\NormalTok{leaves), ], phyf)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{data}\NormalTok{(Paracou618)}
\FunctionTok{PhyloEntropy}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ns, }\DecValTok{2}\NormalTok{, Paracou618.Taxonomy)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{PhyloDiversity}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ns, }\DecValTok{2}\NormalTok{, Paracou618.Taxonomy)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{(effectifs }\OtherTok{\textless{}{-}} \FunctionTok{read.csv2}\NormalTok{(}\StringTok{"data/rao.effectifs.csv"}\NormalTok{, }\AttributeTok{row.names =} \DecValTok{1}\NormalTok{, }
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{PhyloDiversity}\NormalTok{(Ps, }\AttributeTok{q =} \DecValTok{2}\NormalTok{, phyf)}\SpecialCharTok{$}\NormalTok{Total}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{Dqz}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ns, }\AttributeTok{q =} \DecValTok{1}\NormalTok{, Z)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{\# probabilités}
\NormalTok{D }\OtherTok{\textless{}{-}}\NormalTok{ DistanceMatrix[}\FunctionTok{names}\NormalTok{(Ps), }\FunctionTok{names}\NormalTok{(Ps)]}
\CommentTok{\# Normalisation}
\NormalTok{D }\OtherTok{\textless{}{-}}\NormalTok{ D}\SpecialCharTok{/}\FunctionTok{max}\NormalTok{(D)}
\CommentTok{\# Transformation en matrice de similarité}
\NormalTok{Z }\OtherTok{\textless{}{-}} \DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ D}
\CommentTok{\# Matrice diagonale contenant les probabilités}
\NormalTok{Q }\OtherTok{\textless{}{-}} \FunctionTok{diag}\NormalTok{(Ps)}
\CommentTok{\# Matrice des espèces (les lignes de Sp sont les coordonnées}
\CommentTok{\# des vecteurs)}
\NormalTok{Sp }\OtherTok{\textless{}{-}} \FunctionTok{sqrt}\NormalTok{(Q) }\SpecialCharTok{\%*\%} \FunctionTok{sqrt}\NormalTok{(Z) }\SpecialCharTok{\%*\%} \FunctionTok{sqrt}\NormalTok{(Q)}
\CommentTok{\# Valeurs propres normalisées}
\NormalTok{Lambda }\OtherTok{\textless{}{-}} \FunctionTok{svd}\NormalTok{(Sp)}\SpecialCharTok{$}\NormalTok{d}
\NormalTok{Mu }\OtherTok{\textless{}{-}}\NormalTok{ Lambda}\SpecialCharTok{/}\FunctionTok{sum}\NormalTok{(Lambda)}
\CommentTok{\# Comparaison des valeurs à q=2}
\FunctionTok{Diversity}\NormalTok{(Mu, }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{q }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FunctionTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{3}\NormalTok{, }\FloatTok{0.1}\NormalTok{))}
\CommentTok{\# Réutilisation de Paracou618.Taxonomy au format phylog (cf.}
\CommentTok{\# calcul de FAD)}
\NormalTok{DistanceMatrix }\OtherTok{\textless{}{-}} \FunctionTok{as.matrix}\NormalTok{(Tree}\SpecialCharTok{$}\NormalTok{Wdist}\SpecialCharTok{\^{}}\DecValTok{2}\SpecialCharTok{/}\DecValTok{2}\NormalTok{)}
\NormalTok{Z }\OtherTok{\textless{}{-}} \DecValTok{1} \SpecialCharTok{{-}}\NormalTok{ DistanceMatrix}\SpecialCharTok{/}\FunctionTok{max}\NormalTok{(DistanceMatrix)}
\NormalTok{Divqz }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(q, }\ControlFlowTok{function}\NormalTok{(q) }\FunctionTok{Dqz}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ps, q, Z))}
\NormalTok{Divq }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(q, }\ControlFlowTok{function}\NormalTok{(q) }\FunctionTok{ChaoPD}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ps, }\AttributeTok{q =}\NormalTok{ q, }
    \AttributeTok{PhyloTree =}\NormalTok{ Paracou618.Taxonomy))}
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(q, Divq, Divqz), }\FunctionTok{aes}\NormalTok{(q)) }\SpecialCharTok{+} \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Divqz)) }\SpecialCharTok{+} 
    \FunctionTok{geom\_line}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{y =}\NormalTok{ Divq), }\AttributeTok{lty =} \DecValTok{2}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{labs}\NormalTok{(}\AttributeTok{y =} \StringTok{"Diversité"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{        NSingleCommon[}\DecValTok{2}\NormalTok{]}\SpecialCharTok{/}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{max}\NormalTok{(NDoubleCommon[}\DecValTok{2}\NormalTok{], }\DecValTok{1}\NormalTok{) }\SpecialCharTok{*} \FunctionTok{sum}\NormalTok{(PsCommon[, }
        \DecValTok{1}\NormalTok{][(NsCommon }\SpecialCharTok{==} \DecValTok{1}\NormalTok{)[, }\DecValTok{2}\NormalTok{]])}
\NormalTok{    V }\OtherTok{\textless{}{-}} \FunctionTok{sum}\NormalTok{(PsCommon[, }\DecValTok{2}\NormalTok{]) }\SpecialCharTok{+}\NormalTok{ (NCommunity[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{{-}} \DecValTok{1}\NormalTok{)}\SpecialCharTok{/}\NormalTok{NCommunity[}\DecValTok{1}\NormalTok{] }\SpecialCharTok{*} 
\NormalTok{        NSingleCommon[}\DecValTok{1}\NormalTok{]}\SpecialCharTok{/}\DecValTok{2}\SpecialCharTok{/}\FunctionTok{max}\NormalTok{(NDoubleCommon[}\DecValTok{1}\NormalTok{], }\DecValTok{1}\NormalTok{) }\SpecialCharTok{*} \FunctionTok{sum}\NormalTok{(PsCommon[, }
        \DecValTok{2}\NormalTok{][(NsCommon }\SpecialCharTok{==} \DecValTok{1}\NormalTok{)[, }\DecValTok{1}\NormalTok{]])}
    \FunctionTok{return}\NormalTok{(}\FunctionTok{list}\NormalTok{(}\AttributeTok{U =}\NormalTok{ U, }\AttributeTok{V =}\NormalTok{ V))}
\NormalTok{\}}
\CommentTok{\# Indice de Jaccard corrigé}
\NormalTok{bcJaccard }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(N2Col) \{}
\NormalTok{    ChaoEst }\OtherTok{\textless{}{-}} \FunctionTok{ChaoUV}\NormalTok{(N2Col)}
    \FunctionTok{return}\NormalTok{(}\FunctionTok{min}\NormalTok{(ChaoEst}\SpecialCharTok{$}\NormalTok{U }\SpecialCharTok{*}\NormalTok{ ChaoEst}\SpecialCharTok{$}\NormalTok{V}\SpecialCharTok{/}\NormalTok{(ChaoEst}\SpecialCharTok{$}\NormalTok{U }\SpecialCharTok{+}\NormalTok{ ChaoEst}\SpecialCharTok{$}\NormalTok{V }\SpecialCharTok{{-}} 
\NormalTok{        ChaoEst}\SpecialCharTok{$}\NormalTok{U }\SpecialCharTok{*}\NormalTok{ ChaoEst}\SpecialCharTok{$}\NormalTok{V), }\DecValTok{1}\NormalTok{))}
\NormalTok{\}}
\CommentTok{\# Calcul de l\textquotesingle{}indice entre les carrés i et j de BCI, i\textless{}j.}
\NormalTok{BCIjaccard }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(i, j) \{}
    \ControlFlowTok{if}\NormalTok{ (i }\SpecialCharTok{\textgreater{}=}\NormalTok{ j) }
        \FunctionTok{return}\NormalTok{(}\ConstantTok{NA}\NormalTok{) }\ControlFlowTok{else} \FunctionTok{return}\NormalTok{(}\FunctionTok{bcJaccard}\NormalTok{(}\FunctionTok{t}\NormalTok{(BCI[}\FunctionTok{c}\NormalTok{(i, j), ])))}
\NormalTok{\}}
\CommentTok{\# Calcul de la matrice de dissimilarité entre les 50 carrés}
\NormalTok{ChaoJaccard }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{50}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(i) \{}
    \FunctionTok{sapply}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{50}\NormalTok{, }\ControlFlowTok{function}\NormalTok{(j) }\FunctionTok{BCIjaccard}\NormalTok{(i, j))}
\NormalTok{\})}
\CommentTok{\# Indice de Jaccard, carrés 1 et 2, corrigé}
\FunctionTok{BCIjaccard}\NormalTok{(}\DecValTok{1}\NormalTok{, }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{Shannon}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ns) }\SpecialCharTok{+} \FunctionTok{Shannon}\NormalTok{(}\FunctionTok{colSums}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Nsi)) }\SpecialCharTok{{-}} 
    \FunctionTok{Shannon}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Nsi)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{(Beta }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Nsi, }\DecValTok{2}\NormalTok{, ShannonBeta, }\AttributeTok{Nexp =}\NormalTok{ Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ns, }
    \AttributeTok{Correction =} \StringTok{"ZhangGrabchak"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{sum}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Wi }\SpecialCharTok{*}\NormalTok{ Beta)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{(Alpha }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Nsi, }\DecValTok{2}\NormalTok{, Shannon, }\AttributeTok{CheckArguments =} \ConstantTok{FALSE}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{bcShannon}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ns) }\SpecialCharTok{{-}} \FunctionTok{sum}\NormalTok{(Paracou618.MC}\SpecialCharTok{$}\NormalTok{Wi }\SpecialCharTok{*}\NormalTok{ Alpha)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(tabF }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(effectifs[}\FunctionTok{names}\NormalTok{(phyf}\SpecialCharTok{$}\NormalTok{leaves), ], }\AttributeTok{MARGIN =} \DecValTok{1}\NormalTok{, sum))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{divc}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(tabF), phyf}\SpecialCharTok{$}\NormalTok{Wdist)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{divc}\NormalTok{(effectifs[}\FunctionTok{names}\NormalTok{(phyf}\SpecialCharTok{$}\NormalTok{leaves), ], phyf}\SpecialCharTok{$}\NormalTok{Wdist)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{divc}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{colSums}\NormalTok{(effectifs)), }\FunctionTok{disc}\NormalTok{(effectifs[}\FunctionTok{names}\NormalTok{(phyf}\SpecialCharTok{$}\NormalTok{leaves), }
\NormalTok{    ], phyf}\SpecialCharTok{$}\NormalTok{Wdist))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{disc}\NormalTok{(effectifs[}\FunctionTok{names}\NormalTok{(phyf}\SpecialCharTok{$}\NormalTok{leaves), ], phyf}\SpecialCharTok{$}\NormalTok{Wdist)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{MC }\OtherTok{\textless{}{-}} \FunctionTok{MetaCommunity}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(}\FunctionTok{t}\NormalTok{(BCI)))}

\CommentTok{\# Création d\textquotesingle{}une méta{-}communauté à partir de n carrés de BCI }
\NormalTok{SamplePlots }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (n, q) \{}
\NormalTok{  Plots }\OtherTok{\textless{}{-}} \FunctionTok{sample}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\DecValTok{50}\NormalTok{, n)}
\NormalTok{  Nsi }\OtherTok{\textless{}{-}}\NormalTok{ MC}\SpecialCharTok{$}\NormalTok{Nsi[, Plots]; MCsample }\OtherTok{\textless{}{-}} \FunctionTok{MetaCommunity}\NormalTok{(Nsi)}
\NormalTok{  dp }\OtherTok{\textless{}{-}} \FunctionTok{DivPart}\NormalTok{(q, MCsample, }\AttributeTok{Biased =} \ConstantTok{FALSE}\NormalTok{)}
  \CommentTok{\# Retourne la diversité beta}
  \FunctionTok{return}\NormalTok{(dp}\SpecialCharTok{$}\NormalTok{TotalBetaDiversity)}
\NormalTok{\}}
\CommentTok{\# Calcul de la diversité moyenne à partir des simulations}
\NormalTok{BetaPlots }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{ (q, nPlots, nSimulations) \{}
\NormalTok{  buiw }\OtherTok{\textless{}{-}}\NormalTok{ b }\OtherTok{\textless{}{-}} \FunctionTok{vector}\NormalTok{(}\StringTok{"numeric"}\NormalTok{, }\FunctionTok{length}\NormalTok{(nPlots)); i }\OtherTok{\textless{}{-}} \DecValTok{1}
  \ControlFlowTok{for}\NormalTok{ (Size }\ControlFlowTok{in}\NormalTok{ nPlots) \{}
\NormalTok{    Sims }\OtherTok{\textless{}{-}} \FunctionTok{replicate}\NormalTok{(nSimulations, }\FunctionTok{SamplePlots}\NormalTok{(Size, q))  }
\NormalTok{    b[i] }\OtherTok{\textless{}{-}} \FunctionTok{mean}\NormalTok{(Sims)}
\NormalTok{    buiw[i] }\OtherTok{\textless{}{-}} \FunctionTok{sd}\NormalTok{(Sims)}
\NormalTok{    i }\OtherTok{\textless{}{-}}\NormalTok{ i}\SpecialCharTok{+}\DecValTok{1}
\NormalTok{  \}}
  \CommentTok{\# Retour d\textquotesingle{}un dataframe}
  \FunctionTok{return}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x=}\NormalTok{nPlots, }\AttributeTok{y=}\NormalTok{b, }\AttributeTok{ymin=}\NormalTok{b}\SpecialCharTok{{-}}\NormalTok{buiw, }\AttributeTok{ymax=}\NormalTok{b}\SpecialCharTok{+}\NormalTok{buiw))}
\NormalTok{\}}

\CommentTok{\# Echantillonnage de la diversité beta}
\NormalTok{BetaD }\OtherTok{\textless{}{-}} \FunctionTok{BetaPlots}\NormalTok{(}\AttributeTok{q =} \DecValTok{2}\NormalTok{, }\AttributeTok{nPlots=}\FunctionTok{c}\NormalTok{(}\DecValTok{2}\NormalTok{, }\DecValTok{5}\NormalTok{, }\DecValTok{10}\NormalTok{, }\DecValTok{15}\NormalTok{, }\DecValTok{20}\NormalTok{, }\DecValTok{25}\NormalTok{, }\DecValTok{30}\NormalTok{), }
          \AttributeTok{nSimulations =} \DecValTok{100}\NormalTok{)}
\CommentTok{\# Diversité beta totale}
\NormalTok{dpBCI }\OtherTok{\textless{}{-}} \FunctionTok{DivPart}\NormalTok{(}\AttributeTok{q =} \DecValTok{2}\NormalTok{, MC, }\AttributeTok{Biased =} \ConstantTok{FALSE}\NormalTok{)}
\CommentTok{\# Figure}
\FunctionTok{ggplot}\NormalTok{(BetaD) }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_errorbar}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{x, }\AttributeTok{ymin=}\NormalTok{ymin, }\AttributeTok{ymax=}\NormalTok{ymax)) }\SpecialCharTok{+}
  \FunctionTok{geom\_hline}\NormalTok{(}\AttributeTok{yintercept =}\NormalTok{ dpBCI}\SpecialCharTok{$}\NormalTok{TotalBetaDiversity, }\AttributeTok{lty=}\DecValTok{2}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x=}\StringTok{"Nombre de carrés"}\NormalTok{, }
       \AttributeTok{y=}\FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Diversité "}\NormalTok{, beta)))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{Neutre }\OtherTok{\textless{}{-}} \FunctionTok{DivPart}\NormalTok{(q, Paracou618.MC, }\AttributeTok{Biased =} \ConstantTok{FALSE}\NormalTok{)}
\FunctionTok{plot}\NormalTok{(}\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, Neutre}\SpecialCharTok{$}\NormalTok{GammaDiversity), }\FunctionTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, Paracou618.MC}\SpecialCharTok{$}\NormalTok{Ncommunities),}
     \AttributeTok{type =} \StringTok{"n"}\NormalTok{, }
     \AttributeTok{xlab =} \FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(alpha, }\StringTok{" / "}\NormalTok{, gamma, }\StringTok{" diversity"}\NormalTok{)), }
     \AttributeTok{ylab =} \FunctionTok{expression}\NormalTok{(}\FunctionTok{paste}\NormalTok{(beta, }\StringTok{" diversity"}\NormalTok{)))}
\FunctionTok{rect}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, Neutre}\SpecialCharTok{$}\NormalTok{GammaDiversity, }\DecValTok{1}\NormalTok{, }\AttributeTok{lty=}\DecValTok{2}\NormalTok{)}
\FunctionTok{rect}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, Neutre}\SpecialCharTok{$}\NormalTok{TotalAlphaDiversity, Neutre}\SpecialCharTok{$}\NormalTok{TotalBetaDiversity, }
     \AttributeTok{lty =} \DecValTok{2}\NormalTok{)}
\NormalTok{Phylo }\OtherTok{\textless{}{-}} \FunctionTok{DivPart}\NormalTok{(q, Paracou618.MC, }\AttributeTok{Biased =} \ConstantTok{FALSE}\NormalTok{, }
                 \AttributeTok{Tree =}\NormalTok{ Paracou618.Taxonomy)}
\FunctionTok{rect}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, Phylo}\SpecialCharTok{$}\NormalTok{GammaDiversity, }\DecValTok{1}\NormalTok{, }\AttributeTok{angle=}\DecValTok{135}\NormalTok{, }\AttributeTok{density=}\DecValTok{10}\NormalTok{)}
\FunctionTok{rect}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{, Phylo}\SpecialCharTok{$}\NormalTok{TotalAlphaDiversity, Phylo}\SpecialCharTok{$}\NormalTok{TotalBetaDiversity,}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(dp1 }\OtherTok{\textless{}{-}} \FunctionTok{DivPart}\NormalTok{(q, MC1))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(dp2 }\OtherTok{\textless{}{-}} \FunctionTok{DivPart}\NormalTok{(q, MC2))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{summary}\NormalTok{(dp }\OtherTok{\textless{}{-}} \FunctionTok{DivPart}\NormalTok{(q, MC))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(Djointe }\OtherTok{\textless{}{-}} \FunctionTok{Diversity}\NormalTok{(}\FunctionTok{as.ProbaVector}\NormalTok{(df3), q))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(Dis }\OtherTok{\textless{}{-}}\NormalTok{ Djointe}\SpecialCharTok{/}\NormalTok{dp}\SpecialCharTok{$}\NormalTok{GammaDiversity)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{library}\NormalTok{(}\StringTok{"GoFKernel"}\NormalTok{)}
\NormalTok{k }\OtherTok{\textless{}{-}} \FloatTok{0.2}
\NormalTok{p }\OtherTok{\textless{}{-}} \DecValTok{100}
\NormalTok{d }\OtherTok{\textless{}{-}} \FunctionTok{density.reflected}\NormalTok{(}\FunctionTok{rgamma}\NormalTok{(}\DecValTok{10000}\NormalTok{, }\AttributeTok{shape =}\NormalTok{ k, }\AttributeTok{scale =}\NormalTok{ p), }\AttributeTok{lower =} \DecValTok{0}\NormalTok{)}
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(d}\SpecialCharTok{$}\NormalTok{x, d}\SpecialCharTok{$}\NormalTok{y), }\FunctionTok{aes}\NormalTok{(d.x, d.y)) }\SpecialCharTok{+}
  \FunctionTok{geom\_line}\NormalTok{() }\SpecialCharTok{+}
  \FunctionTok{xlim}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{50}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \FunctionTok{expression}\NormalTok{(lambda[s]), }\AttributeTok{y =} \StringTok{"Densité de probablité"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{library}\NormalTok{(}\StringTok{"iNEXT"}\NormalTok{)}
\NormalTok{ei }\OtherTok{\textless{}{-}} \FunctionTok{iNEXT}\NormalTok{(}\FunctionTok{as.data.frame}\NormalTok{(Samples), }\AttributeTok{q =} \DecValTok{0}\NormalTok{, }\AttributeTok{endpoint =}\NormalTok{ n}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1}\SpecialCharTok{+}\NormalTok{extra), }
            \AttributeTok{knots =} \DecValTok{4}\NormalTok{, }\AttributeTok{se =} \ConstantTok{FALSE}\NormalTok{)}\SpecialCharTok{$}\NormalTok{iNextEst}
\CommentTok{\# Extraction des résultats de l\textquotesingle{}objet obtenu}
\NormalTok{ei }\OtherTok{\textless{}{-}} \FunctionTok{sapply}\NormalTok{(ei, }\ControlFlowTok{function}\NormalTok{(x) x[[}\DecValTok{4}\NormalTok{]][}\DecValTok{4}\NormalTok{])}
\CommentTok{\# Fonction d\textquotesingle{}extrapolation selon Shen et al.}
\FunctionTok{library}\NormalTok{(}\StringTok{"SPECIES"}\NormalTok{)}
\NormalTok{ExtrapolateS }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(Ns) \{}
  \CommentTok{\# Nombre d\textquotesingle{}espèces non observées}
  \FunctionTok{sink}\NormalTok{(}\FunctionTok{tempfile}\NormalTok{()) }\CommentTok{\# Suppression des messages de jacknife()}
\NormalTok{  S0 }\OtherTok{\textless{}{-}} \FunctionTok{jackknife}\NormalTok{(}\FunctionTok{AbdFreqCount}\NormalTok{(Ns))}\SpecialCharTok{$}\NormalTok{Nhat }\SpecialCharTok{{-}}\FunctionTok{sum}\NormalTok{(Ns }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{)}
  \FunctionTok{sink}\NormalTok{() }\CommentTok{\# restauration de l\textquotesingle{}affichage normal}
  \CommentTok{\# Taux de couverture}
\NormalTok{  C }\OtherTok{\textless{}{-}} \FunctionTok{Coverage}\NormalTok{(Ns)}
  \CommentTok{\# Espèces nouvelles}
  \FunctionTok{return}\NormalTok{(S0}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{(}\DecValTok{1} \SpecialCharTok{{-}}\NormalTok{C)}\SpecialCharTok{/}\NormalTok{S0)}\SpecialCharTok{\^{}}\NormalTok{(n}\SpecialCharTok{*}\NormalTok{extra)))}
\NormalTok{\}}
\CommentTok{\# Extrapolation des inventaires}
\NormalTok{eS }\OtherTok{\textless{}{-}} \FunctionTok{apply}\NormalTok{(Samples, }\DecValTok{2}\NormalTok{, ExtrapolateS) }\SpecialCharTok{+}\NormalTok{ S0}
\CommentTok{\# Tirage de nSim communautés de taille n(1+extra)}
\NormalTok{Communities }\OtherTok{\textless{}{-}} \FunctionTok{rmultinom}\NormalTok{(nSim, n}\SpecialCharTok{*}\NormalTok{(}\DecValTok{1} \SpecialCharTok{+}\NormalTok{ extra), Ps)}
\NormalTok{richCommunities }\OtherTok{\textless{}{-}} \FunctionTok{colSums}\NormalTok{(Communities }\SpecialCharTok{\textgreater{}} \DecValTok{0}\NormalTok{)}
\CommentTok{\# Distribution des résultats}
\NormalTok{deCommunities }\OtherTok{\textless{}{-}} \FunctionTok{density}\NormalTok{(richCommunities)}
\NormalTok{deB }\OtherTok{\textless{}{-}} \FunctionTok{density}\NormalTok{(eB)}
\NormalTok{dei }\OtherTok{\textless{}{-}} \FunctionTok{density}\NormalTok{(ei)}
\NormalTok{deS }\OtherTok{\textless{}{-}} \FunctionTok{density}\NormalTok{(eS)}
\CommentTok{\# Figure}
\NormalTok{Xlab }\OtherTok{\textless{}{-}} \StringTok{"Nombre d\textquotesingle{}espèces"}
\NormalTok{Ylab }\OtherTok{\textless{}{-}} \StringTok{"Densité de probabilité"}
\FunctionTok{ggplot}\NormalTok{(}\FunctionTok{data.frame}\NormalTok{(richCommunities, eB, ei, eS)) }\SpecialCharTok{+}
...
\NormalTok{ExtraSAC }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(Ns, N) \{}
    \CommentTok{\# Ns est le vecteur des abondances de l\textquotesingle{}échantillon, N est le}
