...
Seul l'estimateur de l'indice de Simpson, $\xq{\tilde{H}}{2}{}{}{}=(\frac{n}{n-1})(1-\sum_s{{\hat{p}}^{2}_{s}})$ est non biaisé.
Comme l'entropie de Rao est la somme sur les périodes de l'arbre des entropies de Simpson, $\xq{\tilde{H}}{2}{}{}{}(T)=(\frac{n}{n-1})^{2}\!\bar{H}(T)$ est donc sans biais.
