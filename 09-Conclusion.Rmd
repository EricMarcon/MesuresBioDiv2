...
Seul l'estimateur de l'indice de Simpson, $^{2}\!\tilde{H}=(\frac{n}{n-1})(1-\sum_s{{\hat{p}}^{2}_{s}})$ est non biaisé.
Comme l'entropie de Rao est la somme sur les périodes de l'arbre des entropies de Simpson, $^{2}\!\tilde{H}(T)=(\frac{n}{n-1})^{2}\!\tilde{H}(T)$ est donc sans biais.
