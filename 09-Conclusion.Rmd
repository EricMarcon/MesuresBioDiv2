...
Comme l'entropie de Rao est la somme sur les périodes de l'arbre des entropies de Simpson, $^{2}\!\tilde{H}(T)=[n/(n-1)]\,^{2}\!\tilde{H}(T)$ est donc sans biais.
