...
```{r SARCode, eval=FALSE, tidy=FALSE, size='footnotesize'}
library("vegan")
data(BCI)
...
```{r SADCode, eval=FALSE, tidy=FALSE, size='footnotesize'}
...
```{r RACCode, eval=FALSE, tidy=FALSE, size='footnotesize'}
library("entropart")
