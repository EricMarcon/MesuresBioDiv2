...
```{r SARCode, eval=FALSE, tidy=FALSE, size='tiny'}
library("vegan")
data(BCI)
...
```{r SADCode, eval=FALSE, tidy=FALSE, size='tiny'}
...
```{r RACCode, eval=FALSE, tidy=FALSE, size='tiny'}
library("entropart")
