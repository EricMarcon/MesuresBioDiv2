...
La diversité est classiquement estimée à plusieurs niveaux emboîtés, nommés $\alpha$, $\beta$ et $\gamma$ par  @Whittaker1960 [page 320] qui a nommé $\alpha$ la diversité locale qu'il mesurait avec l'indice $\alpha$ de Fisher (voir Section&nbsp;\@ref(chap:Fisher)) et a utilisé les lettres suivantes selon ses besoins.
...
L'approche phylogénétique (Section&nbsp;\@ref(chap:Phyloentropie)) permet de contourner le problème : si deux taxons très semblables apportent à peine plus de diversité qu'un seul taxon, le choix de les distinguer ou non n'est pas critique.
...
L'ensemble du code est disponible sur GitHub ^[<https://github.com/EricMarcon/MesuresBioDiv>] où se trouvent les mises à jour de ce document.
