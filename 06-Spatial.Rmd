...
```{r gammaCode, eval=FALSE, size='tiny', tidy=FALSE}
library("GoFKernel")
k <- 0.2
p <- 100
...
Le code R nécessaire pour réaliser la figure est:
```{r nbinCode, eval=FALSE, size='tiny', tidy=FALSE}
...
```{r KemptonQCode, eval=FALSE, size='tiny', tidy=FALSE}
...
Le code R nécessaire pour réaliser la figure est:
```{r specaccumCode, eval=FALSE, size='tiny'}
data(BCI)
...
Le code R nécessaire pour réaliser la figure est:
```{r Beguinot2015Code, eval=FALSE, size='tiny', tidy=FALSE}
...
Le code R nécessaire pour réaliser la figure est:
```{r Beguinot2015aCode, eval=FALSE, size='tiny', tidy=FALSE}
ggplot() +
