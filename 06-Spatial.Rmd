...
```{r specaccumFig, fig.cap="Courbe d'accumulation des espèces d'arbres de Barro Colorado Island. Calcul par specaccum: accumulation des 50 carrés avec permutations.", ref.label="specaccumCode"}
```
...
```{r SACzetaFig, fig.cap="Courbe d'accumulation des espèces d'arbres de Barro Colorado Island. Somme des entropies de Simpson généralisées.", ref.label="SACzetaCode"}
```
