...
La courbe obtenue est en figure&nbsp;\@ref(fig:NonObserve).
...
La figure&nbsp;\@ref(fig:comProfilzeta) montre les profils de diversité (en nombre effectifs d'espèces) des deux parcelles 6 et 18 de Paracou: 1&nbsp;ha inventorié, respectivement 681 et 483 arbres, pour une richesse estimée à 254 et 309 espèces par les estimateurs jackknife d'ordres 2 et 3:
```{r Paracou618S}
...
Code R pour réaliser la figure&nbsp;\@ref(fig:comProfilzeta):
...
En comparaison, la figure&nbsp;\@ref(fig:comProfilHCDT) montre les profils de diversité HCDT des mêmes parcelles.
...
Un profil d'équitabilité calculé de cette façon est présenté en figure&nbsp;\@ref(fig:BCIEqFig).
...
En revanche, dans une communauté log-normale de richesse fixe mais insuffisamment échantillonnée, les corrélations sont négatives (Figure&nbsp;\@ref(fig:NJLogNormale)).
