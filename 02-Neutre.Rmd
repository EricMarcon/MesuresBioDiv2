...
L'espérance du nombre d'espèces non observées est \@ref(eq:Esnnu) $\sum_s{(1-p_s)^n}$, qui décroît beaucoup plus rapidement que $\sum_{i}{\frac{a_i}{n^i}}$: l'hypothèse est bien fausse.
...
#### Choix de l'estimateur {#ec:ChoixEstimateur}
