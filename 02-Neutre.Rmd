...
```{r BCIEqFig, echo=FALSE, results='hide', ref.label='BCIEqCode', fig.cap="Profil d'équitabilité de BCI: représentation alternative de la figure \\@ref(fig:ProfilIneqFig). L'équitabilité est ici normalisée selon Jost."}
```
